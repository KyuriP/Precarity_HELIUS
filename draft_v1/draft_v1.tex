...
precarity factors. In contrast, including individual symptoms provide a
more detailed understanding, capturing the diverse ways symptoms respond
to different precarity factors. However, this approach introduces
methodological challenges, such as non-standard distributions and the
complexities of increased dimensionality. Finally, examining individual
...
precarity. By integrating these three approaches, we balance simplicity
and granularity, ensuring robust findings.

To address sensitivity to parameter values and enhance the robustness of
our results, we implement multiple settings combined with bootstrapping.
For each of the 100 bootstrap samples, we estimate causal graphs and
retain only the edges and directions that exceed predefined thresholds.
...
the number of bootstrap samples to 30 to ease computational demands.
...
\includegraphics[width=0.8\textwidth,height=\textheight]{img/presum_graph_refined.png}
...
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v1_files/figure-pdf/unnamed-chunk-15-1.pdf}
\end{center}
\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v1_files/figure-pdf/unnamed-chunk-15-2.pdf}
\end{center}
\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v1_files/figure-pdf/unnamed-chunk-15-3.pdf}
\end{center}
\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v1_files/figure-pdf/unnamed-chunk-15-4.pdf}
\end{center}
\end{minipage}%
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=\textheight]{draft_v1_files/figure-pdf/unnamed-chunk-16-1.pdf}
\end{center}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{img/pc_presum_GaussianCIRCoT.png}

}

\subcaption{\label{fig-pc_presum-1}Using both GaussianCI and RCoT}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{img/pc_presum_onlyRCoT.png}

}

\subcaption{\label{fig-pc_presum-2}Using only RCoT}
...
\includegraphics[width=0.7\textwidth,height=\textheight]{img/presumgraph_mat.pdf}
