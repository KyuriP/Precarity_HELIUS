...
# ## FCI only (RCoT and Gaussian - tie dashed)
...
# dot.edge("dep", "glt", dir="both", arrowhead="normal", arrowtail="normal")
...
# dot.edge("slp", "app", dir="both", arrowhead="normal", arrowtail="odot")
...
# dot.edge("ene", "mot", dir="both", arrowhead="normal", arrowtail="normal")
# dot.edge("ene", "S.fin", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
...
# dot.edge("glt", "P.soc", dir="both", arrowhead="odot", arrowtail="none")
...
# dot.edge("P.emp", "S.fin", dir="both", arrowhead="odot", arrowtail="normal")
...
# dot.render("symptom_graph_FCI", view=True)



## CCI only (RCoT and Gaussian - tie dashed) 
dot.edge("anh", "dep", dir="both", arrowhead="normal", arrowtail="none")
dot.edge("anh", "slp", dir="both", arrowhead="normal", arrowtail="odot")
dot.edge("anh", "ene", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("anh", "app", dir="both", arrowhead="normal", arrowtail="odot")
...
dot.edge("anh", "con", dir="both", arrowhead="normal", arrowtail="odot")
dot.edge("anh", "P.soc", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("anh", "P.hou", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
...
dot.edge("dep", "mot", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("dep", "sui", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("dep", "P.emp", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
dot.edge("dep", "P.soc", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
dot.edge("dep", "S.fin", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")


dot.edge("slp", "ene", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("slp", "app", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("slp", "glt", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
...
dot.edge("app", "mot", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("app", "S.rel", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
dot.edge("app", "S.fin", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")

dot.edge("glt", "con", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("glt", "mot", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("glt", "sui", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("glt", "P.soc", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("glt", "S.rel", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("glt", "S.fin", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")

dot.edge("con", "mot", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("con", "sui", dir="both", arrowhead="tee", arrowtail="tee",  style="dashed")
dot.edge("con", "P.emp", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
...
dot.edge("sui", "P.soc", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("sui", "S.rel", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")

dot.edge("P.emp", "P.hou", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
dot.edge("P.emp", "S.fin", dir="both", arrowhead="normal", arrowtail="normal")

dot.edge("P.soc", "S.rel", dir="both", arrowhead="tee", arrowtail="tee", style="dashed")
dot.edge("P.soc", "S.fin", dir="both", arrowhead="normal", arrowtail="normal")

dot.edge("P.hou", "S.fin", dir="both", arrowhead="normal", arrowtail="normal")
dot.edge("S.fin", "S.rel", dir="both", arrowhead="normal", arrowtail="normal")



# Render and view the graph
dot.render("symptom_graph_CCI", view=True)
