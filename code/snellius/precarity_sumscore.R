## =============================================================================
## Script for Running Causal Discovery with *Sum of Precarity factors*
## =============================================================================
...
sumpre_sym <- depsym |>
  mutate(precarity = P.emp + P.soc + P.hou + S.rel + S.fin) |>
  dplyr::select(-c(P.emp, P.soc, P.hou, S.rel, S.fin))
