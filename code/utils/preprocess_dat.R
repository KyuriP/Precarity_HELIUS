...
## =============================================================================
#' This script loads, cleans, and preprocesses the HELIUS dataset.
#' It prepares standardized variables related to precariousness and depression,
#' constructs derived indicators and creates multiple structured datasets 
#' used in downstream modeling.
#'
#' @details
#' - Constructs derived variables capturing multiple dimensions of precariousness:
#'   employment, social, financial, housing, and cultural.
#' - Creates symptom-level depression variables and a PHQ sum score.
#' - Outputs structured datasets: symptom-level (`depsym`), sum-score-level (`depsum`), 
#'   and aggregated-level (`agg_data`) for modeling and simulation.
## =============================================================================
