...
outcomes depend not only on external support but also on hidden system
properties. More broadly, this work illustrates how combining causal
discovery with dynamical modelling can guide targeted strategies to
improve mental health under socioeconomic stress.
\end{abstract}
...
\hyperref[sec-methods]{Methods}. Financial stress sits ``upstream'': it
pushes up both depressive symptoms and social precariousness. Depression
and precariousness then affect each other in both directions, creating a
feedback loop that can trap people in escalating vulnerability. This
structure helps explain why policies acting at different
points---relieving financial stress, treating depression, or improving
social stability---can have very different downstream effects.}
