...
social precariousness (\textit{P.soc}) are adjacent to PHQsum, but their
endpoint marks do not consistently support an interpretation in which
they precede depression; in fact, the most frequent patterns are often
unresolved or oriented in the opposite direction. By contrast, financial
stress (\textit{S.fin}) shows the most stable adjacency with
...
edge-type proportion matrix shown in panel (b). Panel (b) reports
\emph{selection frequencies} of edge marks across bootstrap resamples
(and specifications), not p-values or significance levels; values close
to 0 or 1 indicate stability of the recovered mark under the procedure.
...
greater opacity indicating higher selection frequency in the inferred
edge
