...
More broadly, this study offers a general framework for investigating complex mental health dynamics. Causal discovery supports principled hypothesis generation from observational data, while dynamical modeling enables explicit exploration of how hypothesized structures could behave under external change. Together, these tools help move the analysis beyond static description toward testable mechanistic hypotheses that may be relevant for mental health policy and intervention design, while still requiring stronger longitudinal and quasi-experimental evaluation.
