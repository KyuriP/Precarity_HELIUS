...
\addcontentsline{toc}{subsection}{Author Note}

Correspondence concerning this article should be addressed to
\emph{Kyuri Park}, Computational Science Lab, Informatics Institute,
University of Amsterdam, PO Box 94323, Amsterdam, 1090 GH, the
Netherlands. E-mail: k.park@uva.nl.

This work was supported by ZonMW under the project ``\emph{How can we
best act upon contextual factors that influence mental health in lower
socio-economic groups? Insights offered by system dynamics
methodologies}'' (dossier number: 05550032110014). \emph{KP} and
\emph{VVV} acknowledge this funding support.
...
- Kyuri Park: Conceptualization, Methodology, Formal analysis, Writing
-- Original Draft.\\
- Leonie K. Elsenburg: Data curation, Writing -- Review \& Editing.\\
- Mary Nicolaou: Data curation, Writing -- Review \& Editing.\\
- Karien Stronks: Data curation, Funding acquisition, Writing -- Review
\& Editing.\\
- Vítor V. Vasconcelos: Conceptualization, Methodology, Visualization,
Supervision, Writing -- Review \& Editing.

\textbf{Conflicts of interest.} The authors declare no conflicts of
interest.

\textbf{Transparency and openness.} The HELIUS dataset is available upon
request from the Amsterdam UMC data access committee (see
https://www.heliusstudy.nl). The analysis code for the causal discovery
and dynamical simulation models is publicly available at an open
repository.

\emph{This study was not preregistered.}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{draft_v2_psychmethods_files/figure-pdf/fig-dist-1.pdf}
...
representing static financial stress. Financial stress acts as an
upstream driver of depressive symptoms and social precariousness,
...
and anchors our intervention experiments.}
...
\addcontentsline{toc}{subsection}{Data Availibility}
...
\addcontentsline{toc}{subsection}{Code Availibility}
...
\begin{center}
\includegraphics{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-12-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.55\textwidth,height=\textheight]{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-13-1.pdf}
\end{center}

\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-14-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-15-1.pdf}
\end{center}
...
\begin{center}
\includegraphics{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-16-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-17-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-18-1.pdf}
\end{center}
...
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-19-1.pdf}
\end{center}
\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-19-2.pdf}
\end{center}
\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-19-3.pdf}
\end{center}
\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-19-4.pdf}
\end{center}
\end{minipage}%
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=\textheight]{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-20-1.pdf}
\end{center}
...
\begin{center}
\includegraphics{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-21-1.pdf}
\end{center}

\begin{center}
\includegraphics{draft_v2_psychmethods_files/figure-pdf/unnamed-chunk-22-1.pdf}
\end{center}
