...
\maketitle
\begin{abstract}
\noindent Socioeconomic precariousness and depression are closely
linked, yet the mechanisms through which they reinforce each other and
shape responses to intervention remain poorly understood. Using data
from more than 21,000 adults in the multi-ethnic HELIUS study, we
applied causal discovery methods to identify directional relationships
between financial stress, domain-specific precariousness, and depressive
symptoms. We then developed a simulation framework that translates these
causal estimates into a dynamic model capable of testing how
interventions might alter system behavior. The analysis identifies
financial stress as a plausible upstream driver of depression, but also
shows that feedback from depressive symptoms to social precariousness
can slow or destabilize recovery. Simulated interventions indicate that
systems with stronger internal feedbacks exhibit slower but more
persistent improvements, whereas weaker feedbacks produce rapid yet
short-lived change. These findings suggest that the success of social or
psychological interventions depends not only on the external support
provided but also on the internal feedback architecture linking economic
stress and mental health. More broadly, the study illustrates how
computational modeling can help explain why structural disadvantage and
depression remain mutually reinforcing, informing strategies for
resilience and equity in population mental health.
\end{abstract}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{draft_v2_SSM_files/figure-pdf/fig-dist-1.pdf}
...
\begin{center}
\includegraphics{draft_v2_SSM_files/figure-pdf/unnamed-chunk-12-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.55\textwidth,height=\textheight]{draft_v2_SSM_files/figure-pdf/unnamed-chunk-13-1.pdf}
\end{center}

\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{draft_v2_SSM_files/figure-pdf/unnamed-chunk-14-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{draft_v2_SSM_files/figure-pdf/unnamed-chunk-15-1.pdf}
\end{center}
...
\begin{center}
\includegraphics{draft_v2_SSM_files/figure-pdf/unnamed-chunk-16-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{draft_v2_SSM_files/figure-pdf/unnamed-chunk-17-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=\textheight]{draft_v2_SSM_files/figure-pdf/unnamed-chunk-18-1.pdf}
\end{center}
...
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v2_SSM_files/figure-pdf/unnamed-chunk-19-1.pdf}
\end{center}
\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v2_SSM_files/figure-pdf/unnamed-chunk-19-2.pdf}
\end{center}
\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v2_SSM_files/figure-pdf/unnamed-chunk-19-3.pdf}
\end{center}
\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\begin{center}
\includegraphics{draft_v2_SSM_files/figure-pdf/unnamed-chunk-19-4.pdf}
\end{center}
\end{minipage}%
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=\textheight]{draft_v2_SSM_files/figure-pdf/unnamed-chunk-20-1.pdf}
\end{center}
...
\begin{center}
\includegraphics{draft_v2_SSM_files/figure-pdf/unnamed-chunk-21-1.pdf}
\end{center}

\begin{center}
\includegraphics{draft_v2_SSM_files/figure-pdf/unnamed-chunk-22-1.pdf}
\end{center}
