...
Shimizu et al. (2006), Hoyer et al. (2008))
\textcolor{BrickRed}{can be useful under acyclicity and stronger functional-form restrictions, but they do not directly address the combination of latent confounding and potential feedback that motivates our analysis.}
...
every graph within the Markov equivalence class, \(Equiv(G)\).
