...
(ancestral-constraint) information rather than identified causal effects
or effect sizes. In particular, any directional tendency involving
\textit{S.fin} and depression is treated as hypothesis-generating, while
the stable \textit{S.fin}--depression connection motivates the broader
hypothesis that economic stressors may contribute to cycles of
psychosocial risk.\}
...
\textcolor{BrickRed}{Here, we provide a short primer for interpreting PAG/MAAG/CPDAG outputs and edge marks used in the Results. Readers who want a longer tutorial-style introduction and simulation-based demonstrations of finite-sample behavior can consult}
